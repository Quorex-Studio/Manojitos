-- Actualización de la tabla orders para soportar detalles de Pago Móvil
ALTER TABLE public.orders 
ADD COLUMN IF NOT EXISTS banco_origen TEXT,
ADD COLUMN IF NOT EXISTS numero_referencia TEXT;

-- Reescribir process_checkout para aceptar y guardar banco_origen y numero_referencia
