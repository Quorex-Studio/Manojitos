...
import { Send, X, Sparkles, Loader } from "reicon-react";
    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 transition-transform hover:-translate-y-0.5 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 animate-breathing"
        >
      ...
      {open && (
        <div
          ...
          className={cn(
            ...
            // Móvil: casi pantalla completa con márgenes.
          ...
          <div className="flex items-center justify-between gap-2 border-b border-border bg-primary px-4 py-3 text-primary-foreground">
            <div className="flex items-center gap-2">
              ...
              <div className="leading-tight">
                ...
                <p className="text-[11px] opacity-80">Asistente de Manojitos</p>
              </div>
            </div>
            <button
              type="button"
